...
public class AzaleaWood implements ModInitializer {
	...
	protected static final Identifier HANGING_SIGN_TEXTURE_ID = Identifier.of(AzaleaWood.MOD_ID, "entity/signs/hanging/azalea");
	protected static final Identifier HANGING_SIGN_GUI_TEXTURE_ID = Identifier.of(AzaleaWood.MOD_ID, "textures/gui/hanging_signs/azalea");
	...
	private static final Identifier AZALEA_HANGING_SIGN_ID = Identifier.of(AzaleaWood.MOD_ID, "azalea_hanging_sign");
	private static final Identifier AZALEA_WALL_HANGING_SIGN_ID = Identifier.of(AzaleaWood.MOD_ID, "azalea_wall_hanging_sign");

	@Override
	public void onInitialize() {

		// Signs
		Block sign = new TerraformSignBlock(SIGN_TEXTURE_ID, AbstractBlock.Settings.copy(Blocks.OAK_SIGN).sounds(BlockSoundGroup.CHERRY_WOOD).registryKey(RegistryKey.of(RegistryKeys.BLOCK, AZALEA_SIGN_ID)));
		Registry.register(Registries.BLOCK, AZALEA_SIGN_ID, sign);

		Block wallSign = new TerraformWallSignBlock(SIGN_TEXTURE_ID, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).sounds(BlockSoundGroup.CHERRY_WOOD).lootTable(sign.getLootTableKey()).registryKey(RegistryKey.of(RegistryKeys.BLOCK, AZALEA_WALL_SIGN_ID)));
		Registry.register(Registries.BLOCK, AZALEA_WALL_SIGN_ID, wallSign);

		Block hangingSign = new TerraformHangingSignBlock(HANGING_SIGN_TEXTURE_ID, HANGING_SIGN_GUI_TEXTURE_ID, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN).sounds(BlockSoundGroup.CHERRY_WOOD_HANGING_SIGN).registryKey(RegistryKey.of(RegistryKeys.BLOCK, AZALEA_HANGING_SIGN_ID)));
		Registry.register(Registries.BLOCK, AZALEA_HANGING_SIGN_ID, hangingSign);

		Block wallHangingSign = new TerraformWallHangingSignBlock(HANGING_SIGN_TEXTURE_ID, HANGING_SIGN_GUI_TEXTURE_ID, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).sounds(BlockSoundGroup.CHERRY_WOOD_HANGING_SIGN).lootTable(hangingSign.getLootTableKey()).registryKey(RegistryKey.of(RegistryKeys.BLOCK, AZALEA_WALL_HANGING_SIGN_ID)));
		Registry.register(Registries.BLOCK, AZALEA_WALL_HANGING_SIGN_ID, wallHangingSign);

		SignItem signItem = new SignItem(sign, wallSign, new Item.Settings().maxCount(16).registryKey(RegistryKey.of(RegistryKeys.ITEM, AZALEA_SIGN_ID)));
		HangingSignItem hangingSignItem = new HangingSignItem(hangingSign, wallHangingSign, new Item.Settings().maxCount(16).registryKey(RegistryKey.of(RegistryKeys.ITEM, AZALEA_HANGING_SIGN_ID)));

...
public interface TerraformCpyBoatData {
    /**
     * Get TerraformCpyBoatData for the requested boat family ID.
     ...
     * @return TerraformCpyBoatData for the requested boat family
     */
    static TerraformCpyBoatData get(Identifier id) {
        return TerraformCpyBoatDataImpl.get(id);
    }
     ...
     * @return TerraformCpyBoatData for the requested boat family
     */
    static Optional<TerraformCpyBoatData> getOptional(Identifier id) {
        return TerraformCpyBoatDataImpl.getOptional(id).map(data -> data);
    }
